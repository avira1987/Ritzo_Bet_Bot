...
# اجرای Local Bot API + بات (ارسال مستقیم فایل در چت)
.\start_local_bot_api.ps1
# یا به صورت جداگانه:
# Start-Process "telegram-bot-api\telegram-bot-api.exe" -ArgumentList "--api-id=X","--api-hash=Y","--local","--http-port=8081"
# $env:LOCAL_BOT_API_URL="http://127.0.0.1:8081"; python bot.py

# بررسی
Get-Process python*, telegram-bot-api* -ErrorAction SilentlyContinue
